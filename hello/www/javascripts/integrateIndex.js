...
var demo = new Vue({
    ...
    methods: {
        displayMem: function() {
            var data = [
                { time: '10:01', used: 70, extra: 50, total: 64 },
                { time: '10:02', used: 62, extra: 60, total: 67 },
                { time: '10:03', used: 30, extra: 80, total: 52 },
                { time: '10:04', used: 44, extra: 70, total: 75 },
                { time: '10:05', used: 90, extra: 70, total: 80 },
                { time: '10:06', used: 30, extra: 70, total: 67 },
                { time: '10:07', used: 50, extra: 70, total: 56 },
                { time: '10:08', used: 35, extra: 70, total: 78 },
                { time: '10:09', used: 75, extra: 70, total: 90 }
            ];
                ...
                points.selectAll(".memtipPoints")
                    ...
                    .on("mouseover", function(d) {
                        ...
                        $(this).tooltip({
                                'container': 'body',
                                'placement': 'left',
                                'title': 'Ritmo Cardiaco: ' + ' | ' + d['used'] + ' PPM',
                                'trigger': 'hover'
                            })
                            .tooltip('show');
                    })
        ...
        displayDisDur: function() {
            ...
            setInterval(function() {
                //throw the old data
                var loopJud = Object.keys(data).length,
                    delNum = 0;
        ...
        displayCount: function() {
            ...
            var data = [
                { time: '10:01', 'PPM': 200, 'Tendencia': 500, 'Frecuencia': 1000 },
                { time: '10:02', 'PPM': 620, 'Tendencia': 600, 'Frecuencia': 1000 },
                { time: '10:03', 'PPM': 300, 'Tendencia': 800, 'Frecuencia': 1000 },
                { time: '10:04', 'PPM': 440, 'Tendencia': 700, 'Frecuencia': 1000 },
                { time: '10:05', 'PPM': 900, 'Tendencia': 900, 'Frecuencia': 1000 },
                { time: '10:06', 'PPM': 300, 'Tendencia': 500, 'Frecuencia': 1000 },
                { time: '10:07', 'PPM': 50, 'Tendencia': 300, 'Frecuencia': 1000 },
                { time: '10:08', 'PPM': 350, 'Tendencia': 70, 'Frecuencia': 1000 },
                { time: '10:09', 'PPM': 750, 'Tendencia': 200, 'Frecuencia': 1000 }
            ];

            var category = ['PPM', 'Tendencia', 'Frecuencia'];

            var drawLine = ['write'],
                drawBar = ['PPM', 'Frecuencia'];
            ...
            function generate(data, id, lineType, axisNum, drawBar, category) {
                ...
                var legendSize = 10,
                    legendColor = { 'PPM': 'rgba(0, 160, 233, .8)', 'Frecuencia': 'rgba(0, 160, 233, .2)', 'Tendencia': '#41DB00' };
                ...
                y.domain([
                    0,
                    d3.max(ddata, function(d) { return d3.max([d['PPM'], d['Frecuencia'], d['Tendencia']]); }) + 50
                ]);

                var line = d3.svg.line()
                    .interpolate(lineType)
                    .x(function(d) { return xTransLen(d['time']); })
                    .y(function(d) { return y(d['Tendencia']); });
                ...
                path.append("path")
                    ...
                    .attr('stroke', legendColor['Tendencia']);
                ...
                points.selectAll(".tipCountPoints")
                    ...
                    .attr("cy", function(d) { return y(d['Tendencia']); })
                    .attr("r", "6px")
                    .on("mouseover", function(d) {
                        ...
                        $(this).popover({
                                ...
                                'html': 'true',
                                'title': d['time'],
                                'content': '<table><tr><td>' + 'Hora ' + '</td><td> | ' + d['time'] + '</td></tr>' + '<tr><td>' + 'Tendencia ' + '</td><td> | ' + d['Tendencia'] + '</td></tr>' + '<tr><td>' + 'PPM' + '</td><td> | ' + d['PPM'] + '</td></tr>' + '<tr><td>' + 'Presión ' + '</td><td> | ' + d['Frecuencia'] + '</td></tr></table>',
                                'trigger': 'hover'
                            })
                            .popover('show');
                    })
            ...
            setInterval(function() {
                //update donut data
                data.push({ time: hAxis + ":" + mAxis, 'PPM': Math.random() * 700 + 200, 'Frecuencia': Math.random() * 500 + 400, 'Tendencia': Math.random() * 700 + 200 });
    ...
    compiled: function() {
        ...
        setInterval(function() {
            self.people_count = Math.round(Math.random() * (120 - 50) + 50);
        }, 2000);
    }
});